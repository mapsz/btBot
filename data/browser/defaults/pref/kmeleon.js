...
pref("general.useragent.vendorSub", "1.5.3");
...
pref("kmeleon.general.skinsCurrent", "FauxS Amber");
...
pref("kmeleon.plugins.adblockplus.load", true);
pref("kmeleon.plugins.searchbarext.load", true);
pref("kmeleon.plugins.spelltest.load", true);
pref("browser.cache.disk.cache_fixer_debug", true);

/********************************************************************************************************/
// Appearance

pref("kmeleon.display.title", "K-Meleon Pro");	

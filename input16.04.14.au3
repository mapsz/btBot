...
local $Label3 = GUICtrlCreateLabel("Оценка:", 8, 192, 45, 17)
local $Label4 = GUICtrlCreateLabel("Страница:", 8, 232, 55, 17)
local $Label5 = GUICtrlCreateLabel("Автопокупка:", 8, 272, 72, 17)
